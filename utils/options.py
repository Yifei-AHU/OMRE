...
def get_args():
    parser = argparse.ArgumentParser(description="OMRE Args")
    ######################## general settings ########################
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='boma+hnm+crsr+reg', help="which loss to use ['boma', 'hnm', 'crsr', 'reg']")
    ...
    parser.add_argument("--gaussian", default=True, action='store_true')
    parser.add_argument("--fusion_uncertainty", default=False, action='store_true')
