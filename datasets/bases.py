...
class BaseDataset(object):
    ...
    def show_dataset_info(self):
        num_train_pids, num_train_imgs, num_train_captions = len(
            self.train_id_container), len(self.train_annos), len(self.train) #   train_annos
...
class Test_ImageTextDataset(Dataset):
    def __init__(self,
                 dataset,
                 transform=None,
                 text_length: int = 77,
    ...
    def __getitem__(self, index):
        ...
        return pid, image_id, img_name, img, caption_tokens
