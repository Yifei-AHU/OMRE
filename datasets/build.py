...
from .bases import FilterDataset, ImageDataset, TextDataset, ImageTextDataset, ImageTextMLMDataset, Test_ImageTextDataset
...
def build_test_loader(args, finetune=False):
    logger = logging.getLogger("IRRA.dataset")
    ...
    if finetune:
        ...
        syn_dataset = __factory[args.pretrain](root=args.root_dir)
    train_set = Test_ImageTextDataset(syn_dataset.train,
                            val_transforms,
                            text_length=args.text_length)
    num_classes = len(syn_dataset.train)
    ...
    return syn_dataset.train, train_loader, num_classes
